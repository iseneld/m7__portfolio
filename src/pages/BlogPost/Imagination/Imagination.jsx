    ...
    <main id="imagination-main">
      <article>
        ...
        <p>
          ...
          we are the only ones experiencing them.
        </p>
        <p>
        ...
        <p>
          ...
          values, identities, beliefs, opinions, and motivations—all this is in
          our minds. In our dreams, a boundless landscape where the laws of
          nature no longer apply. We may think of anything, and it’s right there
          before our mind’s eye.
        </p>
        <p>
          Many of us have trouble grasping the concept of infinity, while easily
          accepting that nothing lies beyond the end of our subjective dreams.
          Our imagination is simply enclosed in a nothingness from which ideas
          arise and fall. Like a sound that grows and fades into silence.
        </p>
        ...
        <p>
          ...
          astonishing rates into what we experience as an impression of reality.
        </p>
        <p>
          ...
          Going deeper, it’s been shown that the emptiness isn’t even empty per
          se but filled with a wide variety of non-atom particles and fields.
        </p>
        <p>
        ...
        <p class="where">Where does it go?</p>
        <p>
          Somehow, this swirling mist enters a state where it vibrates in a way
          as to generate internal resonances that evoke worlds within it that
          would be impossible beyond it. Something unreal is now being generated
          and played out by a cloud of energy in reality.
        </p>
        <p>
        ...
        <p>
          ...
          me as profoundly important, is what this means to our relationship to
          our imagination. It may unlock a more creative way to reason about our
          conscious experience. Myth becomes ordinary. Synthesizing ideas in our
          minds and transmitting them to others; is magic. It’s literally spell
          weaving. We pull realms out of our void and share them in a process
          that reshapes the physical world.
        </p>
        <p>
        ...
        <blockquote>
          ...
          all things thro' narrow chinks of his cavern.' ― William Blake, The
